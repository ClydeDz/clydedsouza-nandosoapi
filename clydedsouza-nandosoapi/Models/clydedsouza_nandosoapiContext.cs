    ...
    public class clydedsouza_nandosoapiContext : DbContext
    {
        ...
        public class MyConfiguration : DbMigrationsConfiguration<clydedsouza_nandosoapiContext>
        {
            ...
            protected override void Seed(clydedsouza_nandosoapiContext context)
            {
                ...
                new Menu {
                    Item = "Grilled Veggie Strips",   Description = "A wholesome combination of chunky veggies and haloumi cheese grilled with Nandoso's PERi-PERi basting served with your choice of side. ", Price = 8 , Type = Type.Veg,
                ...
                new Menu {
                    Item = "Chocolate Lava Brownie",   Description = "Melt with the warmth of molten chocolate oozing from this brownie", Price = 4.2 , Type = Type.NonVeg,
                    Course = Course.Deserts, Level = Level.Mild, OnSpecial = false, Discount = 0, Day ="Monday"
                }
                };
