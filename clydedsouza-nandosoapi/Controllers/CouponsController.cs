...
using clydedsouza_nandosoapi.Models;

namespace clydedsouza_nandosoapi.Controllers
{
    public class CouponsController : ApiController
    {
        private clydedsouza_nandosoapiContext db = new clydedsouza_nandosoapiContext();
